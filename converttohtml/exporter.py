...
from converttohtml.models import Message
...
def _save_to_html_file(chat_contents: str, chats_list: str, filepath: str):
    ...
    t = Template(_load_file_content("converttohtml/resources/template.html"))
    html_output = t.substitute(
        js_code=_load_file_content("converttohtml/resources/main.js"),
        css_code=_load_file_content("converttohtml/resources/styles.css"),
